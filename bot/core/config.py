...
class OneCSettings(EnvBaseSettings):
    ONEC_WOOD_ENDPOINT: str
    ONEC_RATTAN_ENDPOINT: str
    ONEC_WOOD_ORDER: str
    ONEC_RATTAN_ORDER: str
    ONEC_USERNAME: str
    ONEC_PASSWORD: str


class Settings(BotSettings, DBSettings, CacheSettings, OneCSettings):
    DEBUG: bool = False
